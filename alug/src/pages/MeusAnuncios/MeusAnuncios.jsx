...
function MeusAnuncios() {
  ...
  useEffect(() => {
    ...
    const allAds = JSON.parse(localStorage.getItem("anuncios")) || [];
  ...
  return (
    <div className="meusanuncios-container">
      ...
      {anuncios.length === 0 ? (
        <p className="no-ads">Você ainda não possui um anúncios.</p>
      ) : (
               ...
               <option value="Kitnet">Kitnet</option>
                ...
                <>
                  ...
                  <div className="anuncio-buttons">
                    ...
                    <button className="btn-delete" onClick={() => handleDelete(item.id)}>Deletar</button>
                  </div>
                </>
              )}
            </div>
